<template>
	<div class="diy_details page_customized_goods" id="customized_goods_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_customized_goods'>
							<div_customized_goods :obj="obj"></div_customized_goods>
								<div  class="">
...
<script>
	import div_customized_goods from "@/components/diy/div_customized_goods.vue";
	...
	export default {
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/customized_goods/set?customized_goods_id=' + obj["customized_goods_id"], {
					hits
				}, (res) => {
					if(res.result){
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.customized_goods_id;
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "customized_goods",
					source_field: "customized_goods_id",
					source_id: obj["customized_goods_id"],
					user_id
				};
