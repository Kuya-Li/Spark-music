		            ...
		            <div class="col-12">
		                <div class="sw_no">
							...
							<div class="card_notice">
								<div class="notice_title">公告 <router-link to="notice/list" class="not_more more"><span class="mor">更多</span></router-link></div>
								<!-- 公告组件 -->
		...
		<div class="warp article_s">
		    ...
		    <div class="container">
		        <div class="row">
					...
					<!-- 推荐热门歌曲模块(开始) -->
		<div class="ins warp model1" v-if="$check_action('/popular_songs/list', 'get')">
		    <!-- 容器 -->
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
							...
							<div class="text_t"><span></span></div>
		                    <div class="more_box">
		                        <router-link to="/popular_songs/list" class="ins_more more">
		                ...
		                <!-- 热门歌曲推荐列表组件 -->
						<div class="list_popular_songs_box" ins_box>
							<div class="Left_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
                        	</div>
							<list_popular_songs :list="list_popular_songs" />
							<div class="right_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
...
<script>
	...
	export default {
		...
		methods: {
			...
			toToggle(){
				this.isAdmin = !this.isAdmin;
						...
						// 获取热门歌曲列表
			get_popular_songs() {
				let url = "~/api/popular_songs/get_list?";
										url = "~/api/popular_songs/get_hits_list?";
								let param = {
					...
					if (json.result) {
						this.list_popular_songs = json.result.list;
					}
				})
			},
		...
		computed: {
					    list_table_song_information() {
		        var list = this.list_popular_songs;
		        var list_table = [];
		        for (let i = 0; i < list.length; i++) {
		            list_table[i] = {};
		            this.vm_arr_popular_songs.map((o) => {
		                // 第二个中括号是对象的属性
