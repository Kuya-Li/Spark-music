				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 音乐数据 -->
							<div><span>音乐数据</span></div>
							<table_music_data v-if="$check_action('/music_data/table','get')"></table_music_data>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_music_data from "../../components/diy/table_music_data.vue";
	export default {
		data() {
			return {
			};
