				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<table_song_information v-if="$check_action('/song_information/table','get')"></table_song_information>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_song_information from "../../components/diy/table_song_information.vue";
	export default {
		data() {
			return {
			};
