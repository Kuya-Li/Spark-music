				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 热门歌曲 -->
							<div><span>热门歌曲</span></div>
							<table_popular_songs v-if="$check_action('/popular_songs/table','get')"></table_popular_songs>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_popular_songs from "../../components/diy/table_popular_songs.vue";
	export default {
		data() {
			return {
			};
