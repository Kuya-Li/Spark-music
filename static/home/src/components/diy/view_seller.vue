		...
		<el-row class="row_ce"> 
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="卖家账号" prop="seller_account_number">
												<el-input id="seller_account_number" v-model="form_sub['seller_account_number']" placeholder="请输入卖家账号"
							  v-if="user_group === '管理员' || (form_sub['seller_id'] && $check_field('set','seller_account_number')) || (!form_sub['seller_id'] && $check_field('add','seller_account_number'))"></el-input>
					<div v-else-if="$check_field('get','seller_account_number')">{{form_sub['seller_account_number']}}</div>
											</el-form-item>
			</el-col>
