    ...
    <el-form label-position="right" :model="query" class="form p_4" label-width="120">
      <el-row class="rows row1">
                      ...
                      <el-form-item label="歌曲名称">
                                                      <el-input v-model="query.song_title"></el-input>
                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                      <el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
                      <el-form-item label="打分分数">
                                                      <el-input v-model="query.scoring_score"></el-input>
                                                </el-form-item>
                    </el-col>
                                                                                                </el-row>
      <el-row class="rows row2">
         ...
         <el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
            ...
            <el-button v-if="user_group == '管理员' || $check_action('/music_evaluation/table','add') || $check_action('/music_evaluation/view','add')" @click="$router.push('./view?')" class="add">添加</el-button>
						
            <el-button v-if="user_group == '管理员' || $check_action('/music_evaluation/table','del') || $check_action('/music_evaluation/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
                        </el-col>
                ...
                <el-table-column fixed type="selection" tooltip-effect="dark" width="55">
                      ...
                      {{ get_user_regular_users(scope.row['regular_users']) }}
                               ...
                               v-if="user_group == '管理员' || $check_field('get','user_name')" min-width="200">
                                              ...
                                              <el-table-column prop="scoring_score" @sort-change="$sortChange" label="打分分数"
                               v-if="user_group == '管理员' || $check_field('get','scoring_score')" min-width="200">
                                </el-table-column>
                                              <el-table-column prop="evaluation_content" @sort-change="$sortChange" label="评价内容"
                               v-if="user_group == '管理员' || $check_field('get','evaluation_content')" min-width="200">
                                </el-table-column>
      ...
      <el-table-column sortable prop="update_time" label="更新时间" min-width="200">
        <template slot-scope="scope">
          {{ $toTime(scope.row["update_time"],"yyyy-MM-dd hh:mm:ss") }}
                ...
                <el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/music_evaluation/table','set') || $check_action('/music_evaluation/view','set') || $check_action('/music_evaluation/view','get') || $check_action('//table','add') || $check_action('//view','add')" >
        

      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
                     v-if="user_group == '管理员' || $check_action('/music_evaluation/table','set') || $check_action('/music_evaluation/view','set') || $check_action('/music_evaluation/view','get')"
  ...
  export default {
    ...
    data() {
      return {
        ...
        showModal: false,
        // 获取数据地址
        url_get_list: "~/api/music_evaluation/get_list?like=0",
        url_del: "~/api/music_evaluation/del?",
      ...
      closeModal(){
        this.showModal = false;
            ...
            if(user_group != "管理员"){
                                  let sqlwhere = "(";
                                                                                                                                                                                                                                                                                                  if(user_group=="普通用户"){
                            sqlwhere+= "regular_users = " + this.$store.state.user.user_id + " or ";
                          }
