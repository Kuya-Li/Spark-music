<template>
	<div class="diy_details_box diy_div_song_information">
		<div class="warp diy_warp">
			...
			<div class="details_btn_wrap">
																<button class="btn btn-primary details_btn" v-if="$check_action('/song_information/details','set')" @click="change_praise()" ><span>点赞</span></button>
																<button class="btn btn-primary details_btn" v-if="$check_action('/song_information/details','set')" @click="change_collect()" ><span>收藏</span></button>
											</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var song_information_id = this.obj.song_information_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "song_information",
          source_field: "song_information_id",
          source_id: song_information_id
        }, (res) => {
