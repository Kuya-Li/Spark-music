		...
		<el-row class="row_ce"> 
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="用户编号" prop="user_number">
							  ...
							  v-if="user_group === '管理员' || (form_sub['mall_users_id'] && $check_field('set','user_number')) || (!form_sub['mall_users_id'] && $check_field('add','user_number'))"></el-input>
				...
				<el-form-item label="姓名" prop="full_name">
							  ...
							  v-if="user_group === '管理员' || (form_sub['mall_users_id'] && $check_field('set','full_name')) || (!form_sub['mall_users_id'] && $check_field('add','full_name'))"></el-input>
				...
				<el-form-item label="类别" prop="category">
								<el-select id="category" v-model="form_sub['category']"
						v-if="user_group === '管理员' || (form_sub['mall_users_id'] && $check_field('set','category')) || (!form_sub['mall_users_id'] && $check_field('add','category'))">
