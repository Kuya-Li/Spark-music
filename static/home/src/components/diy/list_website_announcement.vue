			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						标题
							...
							<th class="diy_title" v-if="$check_field('get','publisher')">
						发布人
					</th>
							<th class="diy_title" v-if="$check_field('get','release_time')">
						发布时间
					</th>
											<th class="diy_title" v-if="$check_field('get','lower_multi_test')">
						下多测试
					</th>
					</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_datetime" v-if="$check_field('get','release_time')">
						<span>
							{{ $toTime(o["release_time"] ,"yyyy-MM-dd hh:mm:ss") }}
						</span>
					</td>
											<td class="diy_field diy_text" v-if="$check_field('get','lower_multi_test')">
						<span>
							{{ o["lower_multi_test"] }}
						</span>
					</td>
