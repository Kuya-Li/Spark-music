<template>
	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button @click="reset()" style="margin-right: 74px;" class="search_btn_reset">重置</el-button>
														<el-button v-if="$check_option('/customized_goods/table','export_db')" @click="export_db('dataTable')" class="derive" style="margin-right: 155px;">导出</el-button>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column label="操作" min-width="200" v-if="user_group == '管理员' || $check_action('/customized_goods/table','set') || $check_action('/customized_goods/view','set') || $check_action('/customized_goods/view','get') || $check_action('/定制/table','add') || $check_action('/定制/view','add')" >
				...
				<template slot-scope="scope">
					...
					v-if="user_group == '管理员' || $check_action('/customized_goods/table','set') || $check_action('/customized_goods/view','set') || $check_action('/customized_goods/view','get')"
						...
						<span>定制</span>
									...
									<router-link v-if="user_group == '管理员' || $check_comment('/customized_goods/table')" class="e-button el-button--small is-plain el-button--primary"
		...
		methods: {
			...
			get_list_before(param){
				...
				if(user_group != "管理员"){
						switch(user_group){
																																														case "卖家":
							param["seller_account"] = this.user.user_id;
							break;
																																																		}
					}
				return param;
