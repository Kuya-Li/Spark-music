<template>
	...
	<el-row class="rows row2">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="user_group == '管理员' || $check_action('/music_data/table','set') || $check_action('/music_data/view','set') || $check_action('/music_data/view','get') || $check_action('//table','add') || $check_action('//view','add')" >
				...
				<template slot-scope="scope">
					...
					v-if="user_group == '管理员' || $check_action('/music_data/table','set') || $check_action('/music_data/view','set') || $check_action('/music_data/view','get')"
						...
						<router-link v-if="user_group == '管理员' || $check_comment('/music_data/table')" class="e-button el-button--small is-plain el-button--primary"
