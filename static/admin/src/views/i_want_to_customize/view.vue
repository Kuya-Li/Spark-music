	...
	<el-main class="bg edit_wrap comtable_e">
		...
		<el-row class="row_ce"> 
				...
				<el-form-item label="定制类别" prop="custom_category">
								<el-select id="custom_category" v-model="form['custom_category']"						v-if="user_group === '管理员' || (form['i_want_to_customize_id'] && $check_field('set','custom_category')) || (!form['i_want_to_customize_id'] && $check_field('add','custom_category'))">
