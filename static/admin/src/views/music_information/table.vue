<template>
	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button v-if="user_group == '管理员' || $check_action('/music_information/table','del') || $check_action('/music_information/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
																		<el-input v-model="spider_search_word" placeholder="请输入关键词"></el-input>
										<el-button type="primary" @click="getSpider()" class="search_btn_find">爬取</el-button>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column label="操作" min-width="200" v-if="user_group == '管理员' || $check_action('/music_information/table','set') || $check_action('/music_information/view','set') || $check_action('/music_information/view','get') || $check_action('/${table.tableConfig.table_nav_name}/table','add') || $check_action('/${table.tableConfig.table_nav_name}/view','add')" >
				...
				<template slot-scope="scope">
					...
					v-if="user_group == '管理员' || $check_action('/music_information/table','set') || $check_action('/music_information/view','set') || $check_action('/music_information/view','get')"
						...
						<router-link v-if="user_group == '管理员' || $check_comment('/music_information/table')" class="e-button el-button--small is-plain el-button--primary"
        ...
        var tableToExcel = (function() {
            ...
            if(getExplorer() == 'ie') {
                ...
                tableToExcel(tableid)
																		...
																		getSpider() {
				this.$axios.get("http://localhost:5001/spider?search_word="+this.spider_search_word, {}).then((res) => {
					this.get_list();
				}).catch((res) => {
					console.error(res)
				});
