...
class Sqoop(object):
    ...
    def __init__(self, fs=None, create=None, hive_drop_import_delims=None, fields_terminated_by=None,
                 ...
                 hive_partition_value=None, hive_import=None, create_hive_table=None, as_textfile=None,
                 hive_delims_replacement=None,
                 hive_table=None,
                 hive_database=None,
        ...
        if hive_database:
            self._properties['--hive-database'] = hive_database
        if create_hive_table:
            self._properties['--create-hive-table'] = ''
        if hive_overwrite:
    ...
    def perform_import(self, commod=None):
        self.build_command()
        if commod:
            return run(commod, shell=True, universal_newlines=True, capture_output=True, text=True)
        return run(self._command, shell=True, universal_newlines=True, stdout=subprocess.PIPE,
